...
# Database
database = node['service-ldap']['database']['name']
username = node['service-ldap']['database']['username']
password = node['service-ldap']['database']['password']
hostname = node['service-ldap']['database']['hostname']
...
default_context = node['service-ldap']['app']['context']
